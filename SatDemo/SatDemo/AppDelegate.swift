...
//        //let mainViewController = LoginVC(nibName: "LoginVC", bundle:nil)
//        let mainViewController = DomicilioActual(nibName: "DomicilioActual", bundle:nil)
...
//        window?.makeKeyAndVisible()
    ...
    func createSlidingMenu(){
        ...
        let frontViewController =  LoginVC()//create instance of frontVC
        ...
        //self.window?.rootViewController = swRevealVC!;
               ...
               // let mainViewController = LoginVC(nibName: "LoginVC", bundle:nil)
                //let mainViewController = ActividadEconomicaVC(nibName: "ActividadEconomicaVC", bundle:nil)
